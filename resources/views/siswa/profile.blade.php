                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body no-padding">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <!-- menampilkan data siswa dengan nilai dan keterangan  -->
                                        @foreach ($siswa->mapel as $mapel)
                                        <tr>
                                            <td>{{ $mapel->kode }}</td>
                                            <td>{{ $mapel->nama }}</td>
                                            <td>{{ $mapel->semester }}</td>
                                            <td>{{ $mapel->pivot->keterangan}}</td>
                                            ...
                                            <td><a href="#" class="nilai" data-type="text" data-pk="{{ $mapel->id }}"
                                                    ...
                                                    data-title="Edit Nilai">{{ $mapel->pivot->nilai
                                                    }}</a></td>
                                            <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/siswa/{{ $siswa->id }}/addnilai" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="mapel">Keterangan</label>
                        <select name="mapel" id="mapel" class="form-control">
                            @foreach ($siswa->mapel as $item)
                            <option value="">{{ $item->pivot->keterangan }}</option>
                            @endforeach
                        </select>
                    </div>
