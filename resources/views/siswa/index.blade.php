                        ...
                        <div class="panel-body">
                            <div>
                                <button type="button" class="btn btn-primary btn-toastr" data-context="info"
                                    data-message="This is general theme info" data-position="top-right"
                                    data-toggle="modal" data-target="#exampleModal" style="float: right"><i
                                        class="lnr lnr-plus-circle"></i>
                                    Tambah
                                    Data</button>
                            </div>
                            <br><br>
                            <table class="table table-stripped " id="tabelsiswa">
                                <thead>
                                    <tr>
                                        <th>Nama</th>
                                        <th>Kelas</th>
